      ...
      <Card>
        ...
        <CardContent>
          <div className="prose dark:prose-invert space-y-4">
            ...
            <p>
              By accessing the website at SplitExpense, you are agreeing to be
            ...
            <p>
              ...
              materials (information or software) on SplitExpense's website for
              personal, non-commercial transitory viewing only.
            </p>
            <h3 className="text-xl font-bold">Disclaimer</h3>
            <p>
              The materials on SplitExpense's website are provided on an 'as is'
              basis. SplitExpense makes no warranties, expressed or implied, and
